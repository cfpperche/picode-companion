...
def markup(data):
    ...
    for item in data['items']:
        ...
        preview=f'<img data-part-image="{id}" width="480" height="320" alt="" hidden><span class="part-preview-status">Loading 3D preview…</span>' if has_model else '<span class="part-preview-status">3D not modeled</span>'
